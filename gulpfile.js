...
gulp.task('phpcbf', shell.task(['vendor/bin/phpcbf --standard=PSR2 --ignore=vendor/,node_modules/,messagebroker-config src mbc-userAPI-registration.php mbc-userAPI-registration.config.inc']));
